...
if __name__ == '__main__':
    ...
    paddle_pretrained_model_path = args.src_model_path
    ...
    model_parent_folder = os.path.dirname(args.src_model_path)
    dir_pt_inference = os.path.join(model_parent_folder, "inference_rec_svtr_paddle2pytorch_format")
    os.makedirs(dir_pt_inference, exist_ok=True)

    save_name = 'en_ptocr_v3_rec_infer_nodistill.pth'
    save_filepath = os.path.join(dir_pt_inference, save_name)

    converter.save_pytorch_weights(save_filepath)
    print('done.')
